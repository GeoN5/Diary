...
class NavigationActivity : AppCompatActivity() {
    ...
    fun setListener(){
        fab.setOnClickListener {
            startActivity(Intent(this@NavigationActivity, WriteActivity::class.java))
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        ...
        when(curId){
            R.id.setting -> startActivity(Intent(this@NavigationActivity, PrefEditActivity::class.java))
